...
// export interface TMDBPersonCredits {
//   cast: (TMDBMovie & { character?: string; release_date?: string; first_air_date?: string })[];
//   crew: (TMDBMovie & { job?: string; department?: string; release_date?: string; first_air_date?: string })[];
// }
...
// /* ── Popular directors — 5 pages to find enough directors ── */
// export async function getPopularDirectors(): Promise<TMDBPerson[]> {
//   const pages = await Promise.all(
//     [1, 2, 3, 4, 5].map((page) =>
//       tmdbFetch<TMDBPageResult<TMDBPerson>>("/person/popular", {
